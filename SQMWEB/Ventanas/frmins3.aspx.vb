...
Partial Class Ventanas_frmins3
...
#Region "CONTROLES"
    ...
    Protected Sub grvproductos_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles grvproductos.SelectedIndexChanged
        ...
        sb.Append("window.opener.document.forms[0].ctl00_ContentPlaceHolder1_TextBox7.value='" & grvproductos.SelectedRow.Cells(1).Text & "';")
        sb.Append("window.opener.document.forms[0].ctl00_ContentPlaceHolder1_TextBox8.value='" & grvproductos.SelectedRow.Cells(2).Text & "';")
